...
const PaymentScreen: React.FC = () => {
    ...
    const handleUPIPayment = async () => {
        ...
        const upiUrl = `upi://pay?pa=pratik97669966@ybl&pn=Gunjal Patil Bhel And Misal&mc=&tid=${transactionId}&tr=${transactionId}&tn=Payment for services&am=1&cu=INR`;

        // Open the UPI URL
        window.location.href = upiUrl;

        // Simulate payment status check after a delay
        // In a real-world scenario, this should be handled by your backend or payment gateway webhook
        setTimeout(async () => {
